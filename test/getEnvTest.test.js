...
tape('Rule is loaded', function(t) {
  ...
  t.equal(typeof m.exports['patrol-rules-diagnostic-getEnvTest'], 'function', 'getEnvTest rule exported as function');
  var getEnvTest = m.exports['patrol-rules-diagnostic-getEnvTest'];
