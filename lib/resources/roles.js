...
function buildRole(options, type='default') {
  let roleName = 'LambdaCfnRole';
  let role = {
    Resources: {}
  };

  if (type === 'dispatch') {
    roleName = 'LambdaCfnDispatchRole';
  }
  ...
  role.Resources[roleName].Properties.Policies[0].PolicyDocument.Statement.push(
    {
      Effect: 'Allow',
      Action: [
        'sns:Publish'
