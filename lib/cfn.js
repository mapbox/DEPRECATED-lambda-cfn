...
const webhooks = require('./artifacts/webhook');
const snsEvent = require('./artifacts/sns');
const cloudWatchEvent = require('./artifacts/cloudwatch');
const roles = require('./artifacts/roles');
const alarms = require('./artifacts/alarms');
const dispatchArtifacts= require('./artifacts/dispatch');
const lambdaArtifacts = require('./artifacts/lambda');
const cloudfrontParameters = require('./artifacts/parameters');
...
function buildFunction(options) {
  ...
  let lambda = lambdaArtifacts.buildLambda(options);
  ...
  dispatchArtifacts.addDispatchSupport(functionTemplate, options);
...
module.exports.buildLambda = lambdaArtifacts.buildLambda;
