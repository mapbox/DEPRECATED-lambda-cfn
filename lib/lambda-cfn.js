...
function buildFunction(options) {
  ...
  // if no destination, set ApplicationAlarm to ServiceAlarm
...
function buildSnsDestination(options) {
  ...
  if (options.destination && options.destinations.sns) {
    ...
    sns.Variables.ApplicationAlarmSNSTopic = cf.ref('ServiceAlarmSNSTopic');
  }
