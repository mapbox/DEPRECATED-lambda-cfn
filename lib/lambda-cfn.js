...
function buildFunction(options) {
  ...
  return compileFunction(parameters,
                         defaultAlarms,
                         lambda,
                         role,
                         cloudwatchEvent,
...
function buildParameters(options) {
  ...
  // make this eventually configurable for dispatch
  parameters.Parameters.AlarmEmail = {
    Type: 'String',
...
function buildLambda(options) {
  ...
  function buildEnvironmentVariables(options) {
    ...
    params.LambdaCfnAlarmSNSTopic = cf.ref('LambdaCfnAlarmSNSTopic');
  ...
  fn.Resources[options.name] = {
    ...
    Properties: {
      ...
      Environment: {
        Variables: buildEnvironmentVariables(options)
      },
      Handler: 'function',
